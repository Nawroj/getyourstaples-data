...
products = scraper.scrape_pages(
    'https://www.woolworths.com.au/shop/browse/home-lifestyle?isHideEverydayMarketProducts=true&excludeUnavailableProducts=true&sortBy=Name',
    start_page=1,
    end_page=999
)
...
if products:
    ...
    scraper.save_to_csv(products, filename='woolworths_home_and_lifestyle.csv')
else:
